...
class GCodeLogger():
    ...
    def write(self, data):
        ...
        print('GCodeLogger', 'Writing: {}'.format(data))
...
class CNCDriver(object):
    ...
    def wait_for_stat(self, stat=None):
        if self.DEBUG_ON:
            print("Serial", "Turning on debug mode.")
            print("Serial", "Awaiting stat responses.")
    ...
    def write_to_serial(self, data, max_tries=10, try_interval=0.2):
        print("Serial", "Write: {}".format(str(data).encode()))
        if self.connection is None:
            print("Serial", "No connection found.")
            return
        if self.connection.isOpen():
            ...
            print("Serial", "Cannot connect to serial port.")
    ...
    def move(self, x=None, y=None, z=None, speed=None, absolute=True, **kwargs):
        ...
        print("MotorDriver", "Moving: {}".format(args))
...
class OpenTrons(CNCDriver):
    ...
    def __init__(self, pipette, **kwargs):
